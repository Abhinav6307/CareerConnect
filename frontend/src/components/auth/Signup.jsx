          ...
          <div className='flex items-center justify-center max-w-7xl mx-auto'>
            <form
              ...
              <div className='my-2'>
                ...
                <Input type="text" value={input.fullname} name="fullname" onChange={changeEventHandler} placeholder="John" />
              </div>
              <div className='my-2'>
                <Label>Email</Label>
              ...
              <div className='my-2'>
                ...
                <Input type="password" value={input.password} name="password" onChange={changeEventHandler} placeholder="abc123" />
              </div>
              ...
              {!showOtp ? (
                ...
                <>
                  ...
                  <Button type="button" onClick={handleVerifyOtpAndRegister} className="w-full my-4">
                    {loading ? <Loader2 className='mr-2 h-4 w-4 animate-spin' /> : 'Verify & Signup'}
                  </Button>
                </>
              )}
